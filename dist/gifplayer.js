...
var src_GifPlayer = __webpack_require__(5);
...
var GifPlayer_GifPlayer = function GifPlayer(_ref) {
  var gif = _ref.gif,
      ...
      toggle = _ref.toggle,
      onLoad = _ref.onLoad,
      rest = _objectWithoutPropertiesLoose(_ref, ["gif", "still", "playing", "toggle", "onLoad"]);
...
// EXTERNAL MODULE: ./node_modules/libgif/libgif.js
var libgif = __webpack_require__(4);
var libgif_default = /*#__PURE__*/__webpack_require__.n(libgif);
...
function (_React$Component) {
  ...
  function GifPlayerContainer(props) {
    ...
    _this.updateId = -1;
    _this.loopCount = 0;
    _this.onPlayEnd = _this.onPlayEnd.bind(_assertThisInitialized(_this));
    return _this;
  }
  ...
  _proto.onPlayEnd = function onPlayEnd(data) {
    this.loopCount++;

    if (this.props.onPlayEnd) {
      this.props.onPlayEnd({
        type: 'playEnd',
        ms: this.superGif.get_duration_ms(),
        duration: this.superGif.get_duration(),
        frame: this.superGif.get_current_frame()
      });
    }
